...
- [ ] Таблица абсолютных позиций основных параметров(т.е. formatName, formatVersion, titlesTableLength, titlesTable)
- [ ] Служебные функции: разбивка n бит число на 8битные группы. 
